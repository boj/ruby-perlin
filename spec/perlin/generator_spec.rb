    ...
    describe "chunk 2D" do
      ...
      describe "SIMPLEX" do
        ...
        it "should work with a block" do
          ...
          arr.should eq [[0.3353644531228476, 1.0, 2.0], [0.19956992864608764, 1.0, 3.0], [-0.14786987723329942, 1.0, 4.0], [-0.015269053664457142, 1.0, 5.0], [0.06330469303329524, 2.0, 2.0], [0.14797919215181748, 2.0, 3.0], [0.6964946275780389, 2.0, 4.0], [0.16488039129141768, 2.0, 5.0], [0.14797919215181748, 3.0, 2.0], [0.3145651348893048, 3.0, 3.0], [0.21095079795844954, 3.0, 4.0], [3.090576098737001e-07, 3.0, 5.0]]
        end
      end
    ...
    describe "chunk 3D" do
      describe "SIMPLEX" do
        ...
        it "should work with a block" do
          ...
          arr.should eq [[0.0, 6.0, 5.0, 4.0], [0.7600998644617093, 6.0, 6.0, 4.0], [-0.7600998644617093, 7.0, 5.0, 4.0], [0.6522208451958038, 7.0, 6.0, 4.0], [0.0647275250791234, 8.0, 5.0, 4.0], [0.0, 8.0, 6.0, 4.0]]
